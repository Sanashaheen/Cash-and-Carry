...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Cash N Carry!</h1>
                    <p>We have the best Fruits, vegetables and Dry fruits for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/1223.jpg" alt="Strawbery's">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Strawberry</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/333.png" alt="Banana's">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Banana's 1 Dozen</h3>
                                    <p>Price: Rs. 200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/1667.png" alt="Apples">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Apples</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/443.jpg" alt="Oranges">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Oranges</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pineapple.jpg" alt="pineapples">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pineapple</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/2211.jpeg" alt="Water melon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Water melon 8 KG</h3>
                                    <p>Price: Rs. 550.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/imag.jpg" alt="melons">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Melons 1 KG</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/1122.jfif" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pumpkin 5 KG</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/3322.jfif" alt="Mangoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mangoes 3 KG</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/4433.jfif" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Avocado's 5KG</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/899.jfif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Appricots 1 KG</h3>
                                    <p>Price: Rs. 280.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/peas.jpg" alt="Pease">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pease</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ladyfinger.jpg" alt="lady finger">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lady Finger</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/eggplant.jpg" alt="eggplant">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Eggplant</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bellpepper.jpg" alt="bell pepper">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bell pepper</h3>
